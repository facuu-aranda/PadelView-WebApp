...
import { A as clientAddressSymbol, C as isRoute500, D as REDIRECT_STATUS_CODES, E as DEFAULT_404_COMPONENT, M as originPathnameSymbol, N as pipelineSymbol, O as REROUTABLE_STATUS_CODES, P as responseSentSymbol$1, S as isRoute404, T as ASTRO_GENERATOR, _ as isRenderInstruction, a as chunkToString, b as renderEndpoint, c as renderSlotToString, d as decodeKey, f as decryptString, i as renderComponent, j as fetchStateSymbol, k as appSymbol, l as isRenderTemplateResult, n as renderPage, o as createSlotValueFromString, p as generateCspDigest, r as renderJSX, u as renderTemplate, v as isAstroComponentFactory, w as ASTRO_ERROR_HEADER } from "./chunks/server_C4xiHXPV.mjs";
...
var middlewareSecret = "e66c054d-c9e8-41b2-93d5-baeac0c432b1";
//#endregion
...
[
	...
	},
	{
		...
		"styles": [],
		"routeData": {
			"route": "/api/webhook/match-completed",
			"isIndex": false,
			"type": "endpoint",
			"pattern": "^\\/api\\/webhook\\/match-completed\\/?$",
			"segments": [
				[{
					"content": "api",
					"dynamic": false,
			...
			"params": [],
			"component": "src/pages/api/webhook/match-completed.ts",
			"pathname": "/api/webhook/match-completed",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": ["match_id"],
			"component": "src/pages/partido/[match_id].astro",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
...
var _page0 = () => import("./chunks/generic_xYcd9Y8T.mjs");
var _page1 = () => import("./chunks/match-completed_BbLRo--X.mjs");
var _page2 = () => import("./chunks/_match_id__0Qaogh6d.mjs");
var _page3 = () => import("./chunks/index_DY-MG0Gk.mjs");
var pageMap = /* @__PURE__ */ new Map([
	["node_modules/astro/dist/assets/endpoint/generic.js", _page0],
	["src/pages/api/webhook/match-completed.ts", _page1],
	["src/pages/partido/[match_id].astro", _page2],
	["src/pages/index.astro", _page3]
]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///D:/Dev/ViewPadel/web-portal/","cacheDir":"file:///D:/Dev/ViewPadel/web-portal/node_modules/.astro/","outDir":"file:///D:/Dev/ViewPadel/web-portal/dist/","srcDir":"file:///D:/Dev/ViewPadel/web-portal/src/","publicDir":"file:///D:/Dev/ViewPadel/web-portal/public/","buildClientDir":"file:///D:/Dev/ViewPadel/web-portal/dist/client/","buildServerDir":"file:///D:/Dev/ViewPadel/web-portal/dist/server/","adapterName":"@astrojs/vercel","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/generic.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/webhook/match-completed","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/webhook\\/match-completed\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"webhook","dynamic":false,"spread":false}],[{"content":"match-completed","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/webhook/match-completed.ts","pathname":"/api/webhook/match-completed","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":"*,:before,:after{box-sizing:border-box;margin:0;padding:0}html,body{background-color:#0b0f19;width:100%;min-height:100%;margin:0;padding:0;font-family:Outfit,sans-serif;overflow-x:hidden}input,select,button{min-width:0;font-family:inherit}\n"},{"type":"external","src":"_astro/_match_id_.CGZDb3jV.css"}],"routeData":{"route":"/partido/[match_id]","isIndex":false,"type":"page","pattern":"^\\/partido\\/([^/]+?)\\/?$","segments":[[{"content":"partido","dynamic":false,"spread":false}],[{"content":"match_id","dynamic":true,"spread":false}]],"params":["match_id"],"component":"src/pages/partido/[match_id].astro","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":"*,:before,:after{box-sizing:border-box;margin:0;padding:0}html,body{background-color:#0b0f19;width:100%;min-height:100%;margin:0;padding:0;font-family:Outfit,sans-serif;overflow-x:hidden}input,select,button{min-width:0;font-family:inherit}\n"},{"type":"external","src":"_astro/index.7DR_zJkl.css"}],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["D:/Dev/ViewPadel/web-portal/src/pages/index.astro",{"propagation":"none","containsHead":true}],["D:/Dev/ViewPadel/web-portal/src/pages/partido/[match_id].astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"astro/entrypoints/prerender":"prerender-entry.BkhSM-bW.mjs","\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","@astrojs/vercel/entrypoint":"entry.mjs","\u0000virtual:astro:page:src/pages/partido/[match_id]@_@astro":"chunks/_match_id__0Qaogh6d.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/generic@_@js":"chunks/generic_xYcd9Y8T.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_DY-MG0Gk.mjs","\u0000virtual:astro:page:src/pages/api/webhook/match-completed@_@ts":"chunks/match-completed_BbLRo--X.mjs","D:/Dev/ViewPadel/web-portal/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_DObHJDIj.mjs","virtual:astro:noop":"_astro/_virtual_astro_noop.SBldSjMi.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[],"assets":["/favicon.ico","/favicon.svg","/_astro/index.7DR_zJkl.css","/_astro/_match_id_.CGZDb3jV.css"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"WvNGEvsW8SKP/vnZJahPHDLWcJjPEO7CX4vwhLSorOI=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
